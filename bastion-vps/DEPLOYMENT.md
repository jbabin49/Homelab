...
d'utilisateur donnés en exemple (`bastion.example.com`, `admin`, `192.168.1.0/24`, …)
sont fictifs.
...
Internet
    ...
    └── HTTPS (443) ──► Cloudflare ──► Nginx ──► Guacamole (localhost:8080)
                                                     ...
                                                     ▼
                                        ┌──────────────────────────┐
                                        │  Site distant — LAN 192.168.1.0/24 │
                                        │                          │
                                        │ Serveur WireGuard        │
                                        │   (NAT -> LAN)           │
                                        │ Postes RDP/SSH           │
...
2. Fixer `AllowedIPs = 192.168.1.0/24` (le LAN distant ; resserrable en /32 par cible).
